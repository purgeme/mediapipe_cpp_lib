...
class ImageFormat final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:mediapipe.ImageFormat) */ {
 public:
  inline ImageFormat() : ImageFormat(nullptr) {}
  explicit constexpr ImageFormat(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ImageFormat* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ImageFormat>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const ImageFormat& from) {
