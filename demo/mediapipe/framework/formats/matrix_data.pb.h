...
class MatrixData final :
 ...
 public:
  ...
  ~MatrixData() override;
  explicit constexpr MatrixData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MatrixData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline int32_t MatrixData::_internal_rows() const {
  return rows_;
}
inline int32_t MatrixData::rows() const {
  // @@protoc_insertion_point(field_get:mediapipe.MatrixData.rows)
  return _internal_rows();
}
inline void MatrixData::_internal_set_rows(int32_t value) {
  _has_bits_[0] |= 0x00000001u;
  rows_ = value;
}
inline void MatrixData::set_rows(int32_t value) {
...
inline int32_t MatrixData::_internal_cols() const {
  return cols_;
}
inline int32_t MatrixData::cols() const {
  // @@protoc_insertion_point(field_get:mediapipe.MatrixData.cols)
  return _internal_cols();
}
inline void MatrixData::_internal_set_cols(int32_t value) {
  _has_bits_[0] |= 0x00000002u;
  cols_ = value;
}
inline void MatrixData::set_cols(int32_t value) {
