...
#include "mediapipe/graphs/holistic_tracking/holistic_tracking_to_render_data.inc"
    ;  // NOLINT(whitespace/semicolon)

class HolisticTrackingToRenderData : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HolisticTrackingToRenderData);
// clang-format on
