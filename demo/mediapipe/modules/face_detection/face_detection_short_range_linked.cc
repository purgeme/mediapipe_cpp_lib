...
#include "mediapipe/modules/face_detection/face_detection_short_range.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionShortRange : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionShortRange);
// clang-format on
