...
#include "mediapipe/modules/face_detection/face_detection_short_range_by_roi_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionShortRangeByRoiCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionShortRangeByRoiCpu);
// clang-format on
