...
#include "mediapipe/modules/face_detection/face_detection_options_lib_type_name.h"
#include "mediapipe/modules/face_detection/face_detection.pb.h"

namespace {
constexpr char kDescriptorContents[] =
#include "mediapipe/modules/face_detection/face_detection_proto_descriptors.inc"
