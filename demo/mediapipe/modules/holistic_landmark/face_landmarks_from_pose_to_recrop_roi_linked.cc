...
#include "mediapipe/modules/holistic_landmark/face_landmarks_from_pose_to_recrop_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarksFromPoseToRecropRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarksFromPoseToRecropRoi);
// clang-format on
