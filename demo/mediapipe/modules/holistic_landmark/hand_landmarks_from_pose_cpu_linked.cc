...
#include "mediapipe/modules/holistic_landmark/hand_landmarks_from_pose_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandLandmarksFromPoseCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandLandmarksFromPoseCpu);
// clang-format on
