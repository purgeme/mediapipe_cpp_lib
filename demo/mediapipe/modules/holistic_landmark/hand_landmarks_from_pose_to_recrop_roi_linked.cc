...
#include "mediapipe/modules/holistic_landmark/hand_landmarks_from_pose_to_recrop_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandLandmarksFromPoseToRecropRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandLandmarksFromPoseToRecropRoi);
// clang-format on
