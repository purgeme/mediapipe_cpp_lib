...
#include "mediapipe/modules/holistic_landmark/hand_landmarks_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandLandmarksToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandLandmarksToRoi);
// clang-format on
