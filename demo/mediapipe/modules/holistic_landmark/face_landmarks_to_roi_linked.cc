...
#include "mediapipe/modules/holistic_landmark/face_landmarks_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarksToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarksToRoi);
// clang-format on
