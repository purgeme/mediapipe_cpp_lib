...
#include "mediapipe/modules/holistic_landmark/face_landmarks_from_pose_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarksFromPoseCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarksFromPoseCpu);
// clang-format on
