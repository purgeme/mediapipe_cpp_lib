...
#include "mediapipe/modules/holistic_landmark/hand_recrop_by_roi_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandRecropByRoiCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandRecropByRoiCpu);
// clang-format on
