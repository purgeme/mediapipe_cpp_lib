...
#include "mediapipe/modules/holistic_landmark/face_detection_front_detections_to_roi.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceDetectionFrontDetectionsToRoi : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceDetectionFrontDetectionsToRoi);
// clang-format on
