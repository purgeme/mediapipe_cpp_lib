...
#include "mediapipe/modules/holistic_landmark/hand_visibility_from_hand_landmarks_from_pose.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandVisibilityFromHandLandmarksFromPose : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandVisibilityFromHandLandmarksFromPose);
// clang-format on
