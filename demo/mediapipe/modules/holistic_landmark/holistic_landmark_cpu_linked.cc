...
#include "mediapipe/modules/holistic_landmark/holistic_landmark_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class HolisticLandmarkCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HolisticLandmarkCpu);
// clang-format on
