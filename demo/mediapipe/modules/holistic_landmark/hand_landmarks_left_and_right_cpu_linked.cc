...
#include "mediapipe/modules/holistic_landmark/hand_landmarks_left_and_right_cpu.inc"
    ;  // NOLINT(whitespace/semicolon)

class HandLandmarksLeftAndRightCpu : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(HandLandmarksLeftAndRightCpu);
// clang-format on
