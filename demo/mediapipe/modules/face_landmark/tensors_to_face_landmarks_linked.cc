...
#include "mediapipe/modules/face_landmark/tensors_to_face_landmarks.inc"
    ;  // NOLINT(whitespace/semicolon)

class TensorsToFaceLandmarks : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(TensorsToFaceLandmarks);
// clang-format on
