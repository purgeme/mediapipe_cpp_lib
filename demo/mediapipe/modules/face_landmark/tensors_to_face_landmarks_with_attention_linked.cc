...
#include "mediapipe/modules/face_landmark/tensors_to_face_landmarks_with_attention.inc"
    ;  // NOLINT(whitespace/semicolon)

class TensorsToFaceLandmarksWithAttention : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(TensorsToFaceLandmarksWithAttention);
// clang-format on
