...
#include "mediapipe/modules/face_landmark/face_landmarks_model_loader.inc"
    ;  // NOLINT(whitespace/semicolon)

class FaceLandmarksModelLoader : public Subgraph {
 public:
...
REGISTER_MEDIAPIPE_GRAPH(FaceLandmarksModelLoader);
// clang-format on
