...
#include "mediapipe/calculators/tensor/inference_calculator_options_lib_type_name.h"
#include "mediapipe/calculators/tensor/inference_calculator.pb.h"

namespace {
constexpr char kDescriptorContents[] =
#include "mediapipe/calculators/tensor/inference_calculator_proto_descriptors.inc"
