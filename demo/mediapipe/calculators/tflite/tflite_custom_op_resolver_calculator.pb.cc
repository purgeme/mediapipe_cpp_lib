...
namespace mediapipe {
constexpr TfLiteCustomOpResolverCalculatorOptions::TfLiteCustomOpResolverCalculatorOptions(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : use_gpu_(false){}
struct TfLiteCustomOpResolverCalculatorOptionsDefaultTypeInternal {
  constexpr TfLiteCustomOpResolverCalculatorOptionsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~TfLiteCustomOpResolverCalculatorOptionsDefaultTypeInternal() {}
  union {
    TfLiteCustomOpResolverCalculatorOptions _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TfLiteCustomOpResolverCalculatorOptionsDefaultTypeInternal _TfLiteCustomOpResolverCalculatorOptions_default_instance_;
}  // namespace mediapipe
...
const uint32_t TableStruct_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, -1, sizeof(::mediapipe::TfLiteCustomOpResolverCalculatorOptions)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto = {
  false, false, 288, descriptor_table_protodef_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto, "mediapipe/calculators/tflite/tflite_custom_op_resolver_calculator.proto", 
  &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto_once, descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto_deps, 1, 1,
  ...
  file_level_metadata_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto, file_level_enum_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto, file_level_service_descriptors_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto_getter() {
  return &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto(&descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto);
namespace mediapipe {
...
TfLiteCustomOpResolverCalculatorOptions::TfLiteCustomOpResolverCalculatorOptions(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:mediapipe.TfLiteCustomOpResolverCalculatorOptions)
}
...
inline void TfLiteCustomOpResolverCalculatorOptions::SharedCtor() {
use_gpu_ = false;
}
...
inline void TfLiteCustomOpResolverCalculatorOptions::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void TfLiteCustomOpResolverCalculatorOptions::ArenaDtor(void* object) {
  TfLiteCustomOpResolverCalculatorOptions* _this = reinterpret_cast< TfLiteCustomOpResolverCalculatorOptions* >(object);
  (void)_this;
}
void TfLiteCustomOpResolverCalculatorOptions::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
uint8_t* TfLiteCustomOpResolverCalculatorOptions::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TfLiteCustomOpResolverCalculatorOptions::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    TfLiteCustomOpResolverCalculatorOptions::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TfLiteCustomOpResolverCalculatorOptions::GetClassData() const { return &_class_data_; }

void TfLiteCustomOpResolverCalculatorOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TfLiteCustomOpResolverCalculatorOptions *>(to)->MergeFrom(
      static_cast<const TfLiteCustomOpResolverCalculatorOptions &>(from));
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TfLiteCustomOpResolverCalculatorOptions::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto_getter, &descriptor_table_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto_once,
      file_level_metadata_mediapipe_2fcalculators_2ftflite_2ftflite_5fcustom_5fop_5fresolver_5fcalculator_2eproto[0]);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY ::PROTOBUF_NAMESPACE_ID::internal::ExtensionIdentifier< ::mediapipe::CalculatorOptions,
  ...
  TfLiteCustomOpResolverCalculatorOptions::ext(kExtFieldNumber, ::mediapipe::TfLiteCustomOpResolverCalculatorOptions::default_instance());
...
template<> PROTOBUF_NOINLINE ::mediapipe::TfLiteCustomOpResolverCalculatorOptions* Arena::CreateMaybeMessage< ::mediapipe::TfLiteCustomOpResolverCalculatorOptions >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mediapipe::TfLiteCustomOpResolverCalculatorOptions >(arena);
}
